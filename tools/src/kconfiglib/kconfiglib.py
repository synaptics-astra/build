...
# this is a copy of version 061e71f7d78cb057762d88de088055361863deff from https://github.com/ulfalizer/Kconfiglib
"""
Overview
========
    ...
    def _parse_block(self, end_token, parent, prev):
        ...
        while self._next_line():
            ...
            if t0 is _T_CONFIG or t0 is _T_MENUCONFIG:
                ...
                # syna: implement kbuild semantic
                filenames = sorted(iglob(pattern))
                if not filenames:
